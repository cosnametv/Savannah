...
import NetInfo from "@react-native-community/netinfo"; // ✅ FIXED
        ...
        >
          ...
          <View style={styles.progressContainer}>
            <View style={styles.stepItem}>
              <View
                style={[styles.stepCircle, step >= 1 && styles.activeStep]}
              >
            ...
            <View
              style={[styles.connector, step > 1 && styles.connectorActive]}
            />

            <View style={styles.stepItem}>
              <View
                style={[styles.stepCircle, step >= 2 && styles.activeStep]}
              >
          ...
          {step === 2 && (
            <View>
              ...
              >
                <Text style={{ color: isDark ? "#fff" : "#000" }}>
                  {vaccinationDate
                    ...
                    : "Select Vaccination Date (or N/A)"}
                </Text>
              </TouchableOpacity>
              ...
              <View style={styles.navButtons}>
                ...
                <TouchableOpacity
                  style={[
                    styles.bigSubmitButton,
                    isSubmitting && { backgroundColor: "#6b7280" },
                  ]}
                ...
                >
                  {isSubmitting ? (
                    ...
                    <Text style={styles.bigSubmitText}>
                      Submit Form
                    </Text>
                  )}
                </TouchableOpacity>
